...
object Dependencies {
  object Versions {
    ...
    val trace4catsAvro = "0.12.0-RC1+146-d193db1e"
    val trace4catsCloudtrace = "0.12.0-RC1+146-d193db1e"
    val trace4catsDatadog = "0.12.0-RC1+146-d193db1e"
    val trace4catsHttp4s = "0.12.0-RC1+146-d193db1e"
    val trace4catsJaeger = "0.12.0-RC1+146-d193db1e"
    val trace4catsNatchez = "0.12.0-RC1+146-d193db1e"
    val trace4catsNewrelic = "0.12.0-RC1+146-d193db1e"
    val trace4catsOtel = "0.12.0-RC1+146-d193db1e"
    val trace4catsSttp = "0.12.0-RC1+146-d193db1e"
    val trace4catsTailSamplingExtras = "0.12.0-RC1+146-d193db1e"
    val trace4catsDynamicSamplingExtras = "0.12.0-RC1+146-d193db1e"
    val trace4catsZio = "0.12.0-RC1+146-d193db1e"
    val trace4catsZipkin = "0.12.0-RC1+146-d193db1e"
